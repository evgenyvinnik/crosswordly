export const GUESS_WORDS: Record<string, string> = {
  ...
  caret: 'a wedge-shaped mark made on written or printed matter to indicate the place where something is to be inserted',
  ...
  email: 'digital messages sent over networks that let people write, send, and read mail on computers or phones',
  ...
  spore: 'a tiny reproductive cell from fungi, ferns, or bacteria that can grow into a new organism without fertilization',
